...
class StudentDocument extends Model
{
  ...
  static public function getItems($student_id, $is_active)
  {
    ...
    foreach ($student_documents as $key => $student_document) {
      $student_document->key = $key;
      $student_document->document_type = DocumentType::find($student_document->document_type_id, ['name']);
    }
